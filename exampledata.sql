...
('Péter', 'Kovács', '06301234567', 'peter.kovacs@example.com', 'DL123456'),
('Anna', 'Szabó', '06305554433', 'anna.szabo@example.com', 'DL654321'),
('Gábor', 'Tóth', '06307778899', 'gabor.toth@example.com', 'DL789123'),
('Eszter', 'Nagy', '06304443322', 'eszter.nagy@example.com', 'DL456789'),
('Armand', 'Lakatos', '06704208899', 'armand.lakatos@example.com', 'DL287354'),
('Renátó', 'Kis', '06207893322', 'renato.kis@example.com', 'DL987323');
...
(1, '2025-09-05', 44000.00, 'card'),
(2, '2025-09-12', 24000.00, 'cash'),
(3, '2025-09-18', 27000.00, 'transfer'),
(4, '2025-09-20', 22000.00, 'card'),
(5, '2025-09-18', 28000.00, 'transfer'),
(6, '2025-09-22', 52000.00, 'cash');
