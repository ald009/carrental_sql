...
CREATE TABLE Cars(
    ...
    cw ENUM("RED","BLUE","WHITE","BLACK","GRAY","YELLOW","GREEN","SILVER","GOLD","PURPLE","ORANGE"), --szín
    engine VARCHAR(50) NOT NULL, --motor típus
    year_  YEAR NOT NULL, --gyártási év
    daily_rate DECIMAL(10,2) NOT NULL, --napi bérleti díj
    status_ ENUM("available", "rented", "maintenance") NOT NULL, --állapot elérhető, foglalt stb
    deposit_fee DECIMAL(10.2), --foglaló értéke
    contact VARCHAR NOT NULL(50), --elérhetőség
    type_ ENUM("SUV", "sport","családi", "", "chopper","tour",) --autó típus
)
